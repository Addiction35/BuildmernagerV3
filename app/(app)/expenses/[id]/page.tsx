...
export default function PurchaseOrderPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const statusColors: Record<string, string> = {
    ...
    ancelled: "bg-gray-100 text-gray-600",
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between print:hidden">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-gray-800">
            Expense Order {purchaseOrder.expenseNumber || "N/A"}
          </h1>
          <span
        ...
        <div className="grid gap-4  md:grid-cols-3">
          <Card className="shadow border">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-semibold text-gray-500">Expense Date</CardTitle>
            </CardHeader>
            <CardContent>

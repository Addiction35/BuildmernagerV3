  ...
  return (
    <div ref={printRef} className="flex flex-col gap-8 p-6 bg-white">
      ...
      <div className="flex flex-col gap-8">
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="shadow border">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-semibold text-gray-500">Wage Date</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card className="shadow border">
          <CardHeader>
            <CardTitle className="text-lg font-semibold text-gray-700"> Order Items</CardTitle>
          </CardHeader>
          <CardContent>
